...
const OrderListServices = ({ formData, handleChange, editMode }) => {
    ...
    return (
        <Form className="bg-light mb-4">
            ...
            <Row className="mb-3">
                <Form.Group as={Col} controlId={`services-${formData.index}`}>
                ...
                <Form.Group as={Col} controlId={`serviceprice-${formData.index}`}>
                    ...
                    <Form.Control
                        ...
                        readOnly={!editMode}
                    >
                        <option>{formData.serviceprice}</option>
                    </Form.Control>
                </Form.Group>
            </Row>
...
export default OrderListServices;